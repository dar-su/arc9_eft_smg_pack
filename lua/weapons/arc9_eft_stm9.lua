...
SWEP.Description = ARC9:GetPhrase("eft_weapon_stm9_desc")
...
SWEP.ShootSound = path .. "stm9_fire_outdoor_close.wav"
SWEP.ShootSoundIndoor = path .. "stm9_fire_indoor_close.wav"
SWEP.DistantShootSound = path .. "stm9_fire_outdoor_distant.wav"
SWEP.DistantShootSoundIndoor = path .. "stm9_fire_indoor_distant.wav"

SWEP.ShootSoundSilenced = path .. "stm9_fire_outdoor_silenced_close.wav"
SWEP.ShootSoundSilencedIndoor = path .. "stm9_fire_indoor_silenced_close.wav"
SWEP.DistantShootSoundSilenced = path .. "stm9_fire_outdoor_silenced_distant.wav"
SWEP.DistantShootSoundSilencedIndoor = path .. "stm9_fire_indoor_silenced_distant.wav"
...
local rst_tac = {
    { s = randspin, t = 0.13 },
    { s = path .. "ar_jam_boltlock_try2.ogg", t = 0.29 - 4/28 },
    { s = path .. "mp7_mag_out.ogg", t = 0.4  - 4/28},
    { s = randspin, t = 0.75  - 4/28},
    { s = pouchout, t = 0.9 - 4/28 },
    { s = path .. "mp7_mag_in.ogg", t = 1.33 - 0.15 - 4/28 },
    { s = randspin, t = 1.5 - 4/28 },
    {hide = 0, t = 0},
    {hide = 1, t = 0.5- 4/28},
    {hide = 0, t = 0.9- 4/28}
}
...
local rst_tac1 = {
    ...
    { s = randspin, t = 0.75 - 4/28 },
    { s = pouchout, t = 1  - 4/28},
    { s = path .. "mp7_mag_in.ogg", t = 1.33 - 0.15 + 0.1  - 4/28},
    { s = randspin, t = 1.5 - 4/28 },
    {hide = 0, t = 0},
    {hide = 1, t = 0.5- 4/28},
    {hide = 0, t = 1- 4/28}
...
local rst_tac2 = {
    ...
    { s = path .. "mp7_mag_in.ogg", t = 1.56 - 0.15 - 4/28 },
    { s = randspin, t = 1.6 - 4/28 },
    {hide = 0, t = 0},
    {hide = 1, t = 0.5- 4/28},
    {hide = 0, t = 1- 4/28}
}
...
local rst_tac3 = {
    ...
    { s = randspin, t = 0.75 - 4/28 },
    { s = pouchout, t = 1.1 - 4/28},
    { s = path .. "mp7_mag_in.ogg", t = 1.94 - 0.25 - 4/28 },
    { s = randspin, t = 1.9 - 4/28 },
    {hide = 0, t = 0},
    {hide = 1, t = 0.5- 4/28},
    {hide = 0, t = 1.3- 4/28}
}
