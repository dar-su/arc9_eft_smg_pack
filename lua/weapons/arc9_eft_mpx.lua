...
SWEP.DistantShootSound = { path .. "fire_new/mpx_outdoor_distant_loop1.ogg", path .. "fire_new/mpx_outdoor_distant_loop2.ogg" }
SWEP.DistantShootSoundSilenced = { path .. "fire_new/mpx_outdoor_distant_silenced_loop1.ogg", path .. "fire_new/mpx_outdoor_distant_silenced_loop2.ogg" }
