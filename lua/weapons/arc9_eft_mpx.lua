...
SWEP.Description = ARC9:GetPhrase("eft_weapon_mpx_desc")
...
SWEP.CustomizePos = Vector(14, 45, 5)
...
SWEP.ShootSound = { path .. "fire_new/mpx_outdoor_close_loop1.wav", path .. "fire_new/mpx_outdoor_close_loop2.wav", path .. "fire_new/mpx_outdoor_close_loop3.wav", path .. "fire_new/mpx_outdoor_close_loop4.wav" }
SWEP.LayerSound = path .. "fire_new/mpx_outdoor_close_loop_tail.wav"

SWEP.ShootSoundSilenced = { path .. "fire_new/mpx_outdoor_close_silenced_loop1.wav", path .. "fire_new/mpx_outdoor_close_silenced_loop2.wav", path .. "fire_new/mpx_outdoor_close_silenced_loop3.wav", path .. "fire_new/mpx_outdoor_close_silenced_loop4.wav" }
SWEP.LayerSoundSilenced = path .. "fire_new/mpx_outdoor_close_silenced_loop_tail.wav"

SWEP.ShootSoundIndoor = { path .. "fire_new/mpx_indoor_close_loop1.wav", path .. "fire_new/mpx_indoor_close_loop2.wav", path .. "fire_new/mpx_indoor_close_loop3.wav", path .. "fire_new/mpx_indoor_close_loop4.wav" }
SWEP.LayerSoundIndoor = path .. "fire_new/mpx_indoor_close_loop_tail.wav"

SWEP.ShootSoundSilencedIndoor = { path .. "fire_new/mpx_indoor_close_silenced_loop1.wav", path .. "fire_new/mpx_indoor_close_silenced_loop2.wav", path .. "fire_new/mpx_indoor_close_silenced_loop3.wav", path .. "fire_new/mpx_indoor_close_silenced_loop4.wav" }
SWEP.LayerSoundSilencedIndoor = path .. "fire_new/mpx_indoor_close_silenced_loop_tail.wav"

SWEP.DistantShootSound = { path .. "fire_new/mpx_outdoor_distant_loop1.wav", path .. "fire_new/mpx_outdoor_distant_loop2.wav" }
SWEP.DistantShootSoundSilenced = { path .. "fire_new/mpx_outdoor_distant_silenced_loop1.wav", path .. "fire_new/mpx_outdoor_distant_silenced_loop2.wav" }
SWEP.DistantShootSoundIndoor = { path .. "fire_new/mpx_indoor_distant_loop1.wav", path .. "fire_new/mpx_indoor_distant_loop2.wav" }
...
local rst_empty2 = {
    ...
    { s =  path .. "mpx_weap_magin_plastic.ogg", t = 1.88+0.0 },
...
local rst_tac = {
    { s = "arc9_eft_shared/weap_handoff.ogg", t = 0.05 - 4/27},
    { s =  path .. "mpx_weap_magrelease_button.ogg", t = 0.23 - 4/27 },
    { s =  path .. "mp7_mag_out.ogg", t = 0.35 - 4/27 },
    { s = randspin, t = 0.28 - 4/27 },
    { s = pouchout, t = 1.1 - 4/27 },
    -- { s =  path .. "mpx_weap_magin_plastic.ogg", t = 1.65 - 4/27 },
    { s =  path .. "mpx_weap_magin_plastic.ogg", t = 1.88 - 4/27 },
    { s = randspin, t = 2.17 - 4/27 },
    {hide = 0, t = 0},
    {hide = 1, t = 0.6- 4/27},
    {hide = 0, t = 1.1- 4/27}
}
local rst_tac2 = {
    { s = "arc9_eft_shared/weap_handoff.ogg", t = 0.05 - 4/27},
    { s =  path .. "mpx_weap_magrelease_button.ogg", t = 0.23 - 4/27 },
    { s = randspin, t = 0.6 - 4/27 },
    { s =  path .. "mp7_mag_out.ogg", t = 0.75 - 4/27 },
    { s = randspin, t = 1.4 - 4/27 },
    { s = pouchout, t = 1.2 - 4/27 },
    -- { s =  path .. "mpx_weap_magin_plastic.ogg", t = 1.65+0.2 - 4/27 },
    { s =  path .. "mpx_weap_magin_plastic.ogg", t = 1.88+0.0 - 4/27 },
    { s = randspin, t = 2.17+0.2 - 4/27 },
    {hide = 0, t = 0},
    {hide = 1, t = 0.85- 4/27},
    {hide = 0, t = 1.2- 4/27}
}
